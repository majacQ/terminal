...
{
    UNREFERENCED_PARAMETER(pwchUnicode);
    UNREFERENCED_PARAMETER(cchUnicode);
    UNREFERENCED_PARAMETER(pchAnsi);
    UNREFERENCED_PARAMETER(cbAnsi);
    UNREFERENCED_PARAMETER(partialEvent);
